...
public class BookVO {
   ...
   public BookVO(int bno, String title, String deal_code, String product_code, String category, String region,
		String deal_way, String deal_state, String purc_date, int quantity, int hprice, String btitle, String publisher,
		String bwriter, String content, int cnt, String userid, String nickname, String email, String tel, String wdate,
		String thumb, String file1, String file2, String file3, String file4, String file5, long size1, long size2,
		long size3, long size4, long size5, MultipartFile file1mf, MultipartFile file2mf, MultipartFile file3mf,
		MultipartFile file4mf, MultipartFile file5mf, String size1Label, String size2Label, String size3Label,
		String size4Label, String size5Label) {
	this.bno = bno;
	this.title = title;
