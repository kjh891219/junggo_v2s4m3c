...
<DIV class='content_form'>
     ...
     <div class="float_l _left">
      ...
      <div class='inpo'>판매자 정보</div>
        <div class='line_box' id='ul_box_2'></div>
          ...
          <div class="row">
            ...
            <input type='text' name='nickname' id='nickname' value= '관리자' required="required" readonly="readonly" class="col-xs-3 col-lg-3"/>
            </div>
          <div class="row">
          ...
          <div class="row">  
            ...
            <input type='text' name='email' id='email'  required="required" value='abc@mail.com'  class="col-xs-3 col-lg-3">
          </div>
      ...
      <div class=""> 
         <label for='genre' class='need_e'>장르</label>
         <div>
