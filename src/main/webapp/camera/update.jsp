...
<DIV class='content_form'>
     ...
     <div class="float_l _left">
      ...
      <div class="row">
        ...
        <input type='text' name='title' id='title' required="required" value='${cameraVO.title} ' class="col-xs-9 col-lg-9">
      </div>
      <div class="row">
      ...
      <div class='line_box' id='ul_box_1'></div>
        ...
        <input type='text' name='hprice' id='hprice'  required="required" value='${cameraVO.hprice}' class="col-xs-3 col-lg-3">원
        </div>
        <div class="row">       
        <label for='purc_date'  class='col-xs-2 col-lg-2 choice'>구입시기</label>
        <input type='text' name='purc_date' id='purc_date' value='${cameraVO.purc_date}' class="col-xs-3 col-lg-3"> 
        </div>
      <div class="row"> 
        <label for='quantity' class='col-xs-2 col-lg-2 choice'>수량</label>
        <input type='text' name='quantity' id='quantity' value='${cameraVO.quantity}' class="col-xs-3 col-lg-3">
      </div>
      ...
      <div class='inpo'>판매자 정보</div>
         <div class='line_box' id='ul_box_2'></div>
            <div class="row">
              ...
              <input type='text' name='nickname' id='nickname' value= '${cameraVO.nickname}' required="required" readonly="readonly" class="col-xs-3 col-lg-3"/>
              </div>
            <div class="row">
               <label for='tel'  class='col-xs-2 col-lg-2 need'>전화번호</label>
              <input type='text' name='tel' id='tel'  required="required" value='${cameraVO.tel }' class="col-xs-3 col-lg-3"> 
            </div>
            <div class="row">  
              <label for='email' class='col-xs-2 col-lg-2 need'>이메일</label>
              <input type='text' name='email' id='email'  required="required" value='${cameraVO.email }'  class="col-xs-3 col-lg-3">
            </div>
