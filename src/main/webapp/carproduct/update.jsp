 ...
 <DIV class='content_form'>
   ...
   <div class="float_l _left">
    ...
    <div class="">  
     ...
     <div>
       ...
       <option value="${carproductVO.deal_code }" selected="selected">${carproductVO.deal_code }</option>
   ...
   <div>
    <select name='region' id='region'  class="form-control-lg-10-lg-10-lg-10 full" >
            <option value="${carproductVO.region }" selected="selected">${carproductVO.region }</option>
  ...
  <!-- 다섯번째 파일 수정 -->    
    <div id='file5Panel' class="row">
     ...
     <div class="row">
       ...
       <input type='text' name='passwd' id='passwd' value= '${carproductVO.passwd}'/>
     </div>
      <div class="row">
      ...
      <div class="row"> 
        ...
        <input type='text' name='hprice' id='hprice'  required="required" value='${carproductVO.hprice}' class="col-xs-3 col-lg-3">원
      </div>
      <div class="row">       
        <label for='purc_date'  class='col-xs-2 col-lg-2 choice'>구입시기</label>
        <input type='text' name='purc_date' id='purc_date' value='${carproductVO.purc_date}' class="col-xs-3 col-lg-3"> 
      </div>
      <div class="row"> 
        <label for='quantity' class='col-xs-2 col-lg-2 choice'>수량</label>
        <input type='text' name='quantity' id='quantity' value='${carproductVO.quantity}' class="col-xs-3 col-lg-3">
      </div>
      ...
      <div class='line_box' id='ul_box_2'></div>
        <div class="row">
         <label for='nickname' class='col-xs-2 col-lg-2 need'>별명</label>
          <input type='text' name='nickname' id='nickname' value= '${carproductVO.nickname}' required="required" readonly="readonly" class="col-xs-3 col-lg-3"/>
        </div>
        <div class="row">
         <label for='tel'  class='col-xs-2 col-lg-2 need'>전화번호</label>
         <input type='text' name='tel' id='tel'  required="required" value='${carproductVO.tel }' class="col-xs-3 col-lg-3"> 
        </div>
        <div class="row">  
          <label for='email' class='col-xs-2 col-lg-2 need'>이메일</label>
          <input type='text' name='email' id='email'  required="required" value='${carproductVO.email }'  class="col-xs-3 col-lg-3">
        </div>
     ...
     <%--  <div class="form-group">  
      ...
      <label class='label_1'  for='category'>카테고리 코드</label>
       ...
       <li>
        ...
        <input type='text' name='hprice' id='hprice' value='${carproductVO.hprice }' >
      </li>
      ...
      <li>
        ...
        <div>
          <textarea class="form-control" name='content' id='content'  rows='10' cols='70'>${carproductVO.content}</textarea>
        </div>
       </li>
