  ...
  <fieldset>
    ...
    <div class="row">
      ...
      <label for='tel' >*전화번호</label>
        <input type='text' name='tel' id='tel'  required="required" value='${productVO.tel }' class="form-control-lg-10-lg-10-lg-10"> 
      </div>
      </div>
      <hr/>
      <div class="row">
      <div class="col-xs-5"> 
        ...
        <input type='text' name='nickname' id='nickname' value= '${productVO.nickname }' required="required" readonly="readonly" class='form-control-lg-10-lg-10-lg-10-lg-10'/>
      </div>
     <div class="col-xs-5">    
        <label for='passwd'>*패스워드</label>
        <input type='password' name='passwd' id='passwd' value='${productVO.passwd }' required="required" class='form-control-lg-10-lg-10-lg-10'/>
      </div>
      </div>
      <hr/>
     <div class="row">
        ...
        <select name='product_code' id='product_code' class="form-control-lg-10-lg-10-lg-10">
           <option value="${productVO.product_code }" selected="selected">${productVO.product_code }</option>
      ...
      <div class="row">
        ...
        <input type='text' name='hprice' id='hprice'  required="required" value='${productVO.hprice }' class="form-control-lg-10-lg-10-lg-10">원
        </div>
        <div class="col-xs-5">       
        <label for='purc_date' >구입시기</label>
        <input type='text' name='purc_date' id='purc_date' value='${productVO.purc_date }' class="form-control-lg-10-lg-10-lg-10"> 
        </div>
     </div>
      <hr/>
      <div class="row">
      <div class="col-xs-5"> 
        ...
        <input type='text' name='quantity' id='quantity' value='${productVO.quantity}' class="form-control-lg-10-lg-10-lg-10">
      </div>
       <div class="col-xs-5">  
        <label for='email'>*이메일</label>
        <input type='text' name='email' id='email'  required="required" value='${productVO.email}' class="form-control-lg-10-lg-10-lg-10">
        </div>
       </div>
      <hr/>
      <div class="form-group">
        <label for='title'>*제목</label>
        <input type='text' name='title' id='title' required="required" value='${productVO.title} ' class="form-control-lg-10-lg-10-lg-10">
      </div>
      <hr/>
      <div class="form-group">
        <label for='content'>상세설명</label>
        <textarea rows="10" cols="100"  name="content" id="content" placeholder="내용을 입력하세요" class="form-group">${productVO.content}</textarea>
      </div>
        ...
        <div class="col-xs-10 col-lg-10">
          ...
          <c:choose>
            <c:when test="${fn:endsWith(file4, '.jpg')}">
              <IMG src='./storage/${productVO.file3}'>
            </c:when>
        ...
        <div class="col-xs-10 col-lg-10">
          ...
          <c:choose>
            <c:when test="${fn:endsWith(file6, '.jpg')}">
              <IMG src='./storage/${productVO.file5}'>
            </c:when>
        ...
        <div class="col-xs-10 col-lg-10">
          ...
          <c:choose>
            <c:when test="${fn:endsWith(file8, '.jpg')}">
              <IMG src='./storage/${productVO.file7}'>
            </c:when>
        ...
        <div class="col-xs-10 col-lg-10">
          ...
          <c:choose>
            <c:when test="${fn:endsWith(file10, '.jpg')}">
              <IMG src='./storage/${productVO.file9}'>
            </c:when>
