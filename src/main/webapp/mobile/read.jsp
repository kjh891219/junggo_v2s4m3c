...
<jsp:include page="/menu/left.jsp" flush='false' />
 ...
 <h1 style="padding-left: 0px; margin: 0; padding: 10px; float: left; display: block; font-size: 20px; line-height: 22px; font-weight: bold; color: #444;">
  <a href="${pageContext.request.contextPath}/mobile/list.do">게임기기 게시판</a>
 </h1>
...
<span style="float: right; display: inline; font-weight: 400; letter-spacing: 0; color: #444; font-size: 12px;">${fn:substring(mobileVO.wdate, 0, 16) }</span>
<h1 style="font-size: 20px; font-weight: bold; color: #444; overflow: hidden; margin: 0; padding: 0 8px; line-height: 18px;">${mobileVO.title}</h1>
</div>
                 ...
                 <li style="float: left; margin: 0; padding: 0; ">
                          ...
                          <c:choose>
                            <c:when test="${fn:endsWith(file2, '.jpg')}">
                              <a href="./storage/${mobileVO.file2}">
                                 <IMG id='file2' class="gallery" src='./storage/${mobileVO.file2}' width="80" height="80" >
                              </a>
                            </c:when>
                        ...
                        <li style="float: left; margin: 0; padding: 0;">
                          ...
                          <c:choose>
                            <c:when test="${fn:endsWith(file4, '.jpg')}">
                              <a href="./storage/${mobileVO.file4}">
                                 <IMG id='file4' class="gallery" src='./storage/${mobileVO.file4}' width="80" height="80" >
                              </a>
                            </c:when>
                        ...
                        <li>
                          ...
                          <c:choose>
                            <c:when test="${fn:endsWith(file6, '.jpg')}">
                              <a href="./storage/${mobileVO.file6}">
                                 <IMG id='file6' class="gallery" src='./storage/${mobileVO.file6}' width="80" height="80" >
                              </a>
                            </c:when>
                        ...
                        <li>
                          ...
                          <c:choose>
                            <c:when test="${fn:endsWith(file8, '.jpg')}">
                              <a href="./storage/${mobileVO.file8}">
                                 <IMG id='file8' class="gallery" src='./storage/${mobileVO.file8}' width="80" height="80" >
                              </a>
                            </c:when>
                        ...
                        <li >
                          ...
                          <c:choose>
                            <c:when test="${fn:endsWith(file10, '.jpg')}">
                              <a href="./storage/${mobileVO.file10}">
                                 <IMG id='file10' class="gallery" src='./storage/${mobileVO.file10}' width="80" height="80" >
                              </a>
                            </c:when>
...
<div style="clear: both;"></div>
 ...
 <div style="padding: 11px; border-top: 1px solid #CCC; border-bottom: 1px solid #CCC; background: #FCFCFC; display: block; margin-top: 50px; margin-bottom: 50px; display: block;">
  ...
  <button type='button' onclick="location.href='./list.do?mno=${mobileVO.mno}&col=${searchDTO.col}&word=${searchDTO.word}'">목록</button>
</div>
...
<iframe src="${pageContext.request.contextPath}/mo_reply/list.do?mno=${mobileVO.mno}" class='myFrame' width="100%" style="border-style: none;"></iframe>  
