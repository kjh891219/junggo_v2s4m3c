...
function create(rno){
  ...
  var tag = 
   ...
   "<input type='hidden' name='cno' id='cno' value='<c:out value="${cno}"/>'>" +
...
<!-- <DIV id='panel_frm' class='content' style='padding: 10px 0px 10px 0px; width: 100%; text-align: center;'>
              <FORM name='frm' id='frm' method='POST'>
                ...
                <input type="hidden" name="cno" id="cno" value='1'>
...
<jsp:include page="/cosmetic_reply/create.jsp?cno=${cno}" flush='false'/>
    ...
    <table class="table" style='width: 100%; border: none;'>
      <tbody>
        <c:forEach var="vo" items="${list }">
          <tr>
            <td class="td_l" style='border: none; border-bottom: 1px sold lightgray;' >
              <c:choose>
