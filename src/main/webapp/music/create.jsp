  ...
  <div class='line_box' id='ul_box_1'></div>
    <div class="row">
     ...
     <div class="row"> 
        ...
        <input type='text' name='hprice' id='hprice'  required="required" value='0' class="col-xs-3 col-lg-3">원
     </div>
     <div class="row">       
        <label for='purc_date'  class='col-xs-2 col-lg-2 choice'>구입시기</label>
        <input type='date' name='purc_date' id='purc_date' value='' class="col-xs-3 col-lg-3">  
     </div>
      <div class="row"> 
