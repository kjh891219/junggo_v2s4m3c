...
<body leftmargin="0" topmargin="0">
  ...
  <DIV class='content' style='width: 80%;'>
    <FORM name='frm' method='POST' action='./create.do' enctype="multipart/form-data">
      ...
      <fieldset>
        <label>글번호</label> 
        <input type='text' name='ctno' id='ctno' value='${musicVO.ctno }'>
        <ul>
         ...
         <select id="category" name="category">
          ...
          <li><div class="col-xs-5">
              ...
              <input type='number' name='quantity' id='quantity' value=${musicVO.quantity } class=" ">
            </div></li>
          <li><label class='label_1' for='userid'>등록자 ID</label> 
          <input type='text' name='userid' id='userid' value='${musicVO.userid }' required="required"></li>
          <li><label class='label_1' for='email'>등록자 이메일</label> 
          <input type='text' name='email' id='email' value='${musicVO.email }' required="required"> 
            <label class='label_1' for='tel'>등록자 연락처</label> 
            <input type='text' name='tel' id='tel' value='${musicVO.tel }' required="required"></li>
