         ...
         <div class="home_img">
              ...
              <c:choose>
                <c:when test="${fn:endsWith(file1, '.jpg')}">
                  <a href="./read.do?ctno=${vo.ctno}"><IMG id='file1' style="padding:5px; width:190px; height:190px; " src='./storage/${vo.file1}' ></a>
                </c:when>
                ...
                <c:otherwise>
                  <a href="./read.do?ctno=${vo.ctno}"><img id='file1' src="http://i1.daumcdn.net/cfs.tistory/static/images/xBoxReplace_250.png" style="padding:5px; width:100%; height:cover" ></a>
                </c:otherwise>
              </c:choose>
            <div class='both'></div>
        </div>    
            <div class="home_detail" style="width:100%; height:100%; position: absolute; top:0; left:0; padding-top:10%; padding-left:10%; display:none;">
              <a style="display:block; width:100%; height:100%; position:absolute; top:0; left:0;" href="./read.do?ctno=${vo.ctno}"></a>  
