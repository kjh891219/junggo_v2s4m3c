...
<!-- ----------------------------------------- -->
<h1 style="text-align: center;">${sportsVO.title}</h1>
...
<table border="1">
  ...
  <td style="text-align: center;">${sportsVO.deal_code}</td>
  <tr>
  <td style="text-align: center;">분류</td>
  <td style="text-align: center;">${sportsVO.category}</td>
  </tr>
  <tr>
  <td style="text-align: center;">상품구분</td>
  <td style="text-align: center;">${sportsVO.product_code}</td>
  </tr>
  <tr>
  <td style="text-align: center;">거래지역</td>
  <td style="text-align: center;">${sportsVO.region}</td>
  </tr>
  <tr>
  <td style="text-align: center;">거래방식</td>
  <td style="text-align: center;">${sportsVO.deal_way}</td>
  </tr>
  <tr>
  <td style="text-align: center;">구입시기</td>
  <td style="text-align: center;">${sportsVO.purc_date}</td>
  </tr>
  <tr>
  <td style="text-align: center;">수량</td>
  <td style="text-align: center;">${sportsVO.quantity}</td>
  </tr>
  <tr>
  <td style="text-align: center;">희망가격</td>
  <td style="text-align: center;">${sportsVO.hprice}</td>
  </tr>       
</table>  
...
<h2><판매자 정보></h2>
 <table border="1">
  ...
  <td style="text-align: center;">${sportsVO.nickname}</td>
  <tr>
  <tr>
  <td style="text-align: center;">이메일</td>
  <td style="text-align: center;">${sportsVO.email}</td>
  <tr>
  <tr>
  <td style="text-align: center;">전화번호</td>
  <td style="text-align: center;">${sportsVO.tel}</td>
  <tr>
 </table>
</div>
<div  style="clear: both;">
           <li>
            ...
            <span>
              <c:if test="${sportsVO.size2 > 0}">
                <A href='${pageContext.request.contextPath}/download?dir=/sports/storage&filename=${sportsVO.file2}'>${sportsVO.file2}</A> (${sportsVO.size2Label})
              </c:if>
            </span>    
            <div id='file2Panel'>
          ...
          <li>
            ...
            <span>
              <c:if test="${sportsVO.size4 > 0}">
                <A href='${pageContext.request.contextPath}/download?dir=/sports/storage&filename=${sportsVO.file4}'>${sportsVO.file4}</A> (${sportsVO.size4Label})
              </c:if>
            </span>    
            <div id='file4Panel'>
          ...
          <li>
            ...
            <span>
              <c:if test="${sportsVO.size6 > 0}">
                <A href='${pageContext.request.contextPath}/download?dir=/sports/storage&filename=${sportsVO.file6}'>${sportsVO.file6}</A> (${sportsVO.size6Label})
              </c:if>
            </span>    
            <div id='file6Panel'>
           ...
           <li>
            ...
            <span>
              <c:if test="${sportsVO.size8 > 0}">
                <A href='${pageContext.request.contextPath}/download?dir=/sports/storage&filename=${sportsVO.file8}'>${sportsVO.file8}</A> (${sportsVO.size8Label})
              </c:if>
            </span>    
            <div id='file8Panel'>
           ...
           <li>
            ...
            <span>
              <c:if test="${sportsVO.size10 > 0}">
                <A href='${pageContext.request.contextPath}/download?dir=/sports/storage&filename=${sportsVO.file10}'>${sportsVO.file10}</A> (${sportsVO.size10Label})
              </c:if>
            </span>    
            <div id='file10Panel'>
