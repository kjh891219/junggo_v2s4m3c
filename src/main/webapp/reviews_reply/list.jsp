...
function create(rno){
  ...
  var tag = 
   ...
   "<input type='hidden' name='r_no' id='r_no' value='<c:out value="${r_no}"/>'>" +
...
<!-- <DIV id='panel_frm' class='content' style='padding: 10px 0px 10px 0px; width: 100%; text-align: center;'>
              <FORM name='frm' id='frm' method='POST'>
                ...
                <input type="hidden" name="r_no" id="r_no" value='1'>
...
<jsp:include page="/reviews_reply/create.jsp?r_no=${r_no}" flush='false'/>
