...
<script>
     function create_login() {
       ...
       <%session.setAttribute("url", "computer/read.do?ctno="+ctno);%>
       return false;
       <% } else { %>
       return true;
       <% } %>
...
<FORM name='frm' method='POST' action='${pageContext.request.contextPath}/computer_reply/create.do' class='form-inline' onsubmit = 'return create_login()'>
