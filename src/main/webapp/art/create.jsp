   ...
   <div class="form-group">   
      <ul>
       <li>
        ...
        <input type='text' name='nickname' id='nickname'  value='${nickname}'  readonly><br><br>
      ...
      <li>
        ...
        <input type='text' name='purc_date' id='purc_date' value='2016-10' >
       
       <label class='label_1'  for='product_code'>거래구분</label>
