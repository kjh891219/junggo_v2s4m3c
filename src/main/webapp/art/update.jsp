    ...
    <FORM name='frm' method='POST' action='./update.do'
      ...
      <ul>
       <li>
        ...
        <input type='password' name='passwd' id='passwd' value=' ${artVO.passwd}' required="required"><br><br>
         <label class='label_1'  for='nickname'>닉네임</label>
        <input type='text' name='nickname' id='nickname' value=' ${artVO.nickname} '  required="required">
       </li>
       ...
       <li>
        ...
        <input type='text' name='hprice' id='hprice' value='${artVO.hprice }' >
      </li>
      
      <li>
        <label class='label_1'  for='purc_date'>구입시기</label>
        <input type='text' name='purc_date' id='purc_date' value=' ${artVO.purc_date }' >
       ...
       <li>
        ...
        <input type='text' name='title' id='title' size='50' value=' ${artVO.title}'  required="required">
      </li>
      
      <li>
      <label for="content" class="col-xs-2 col-lg-2 control-label">내용</label>
        <div class="col-xs-10 col-lg-10">
          <textarea class="form-control" name='content' id='content'  rows='10' style='width: 100%;'>${artVO.content}</textarea>
        </div>
      </li>
     ...
     <li>
      ...
      <label for="file5MF" >업로드 파일5</label>
        ...
        <input type='text' name='email' id='email'  required="required" value='${artVO.email }' class="form-control-lg-10-lg-10-lg-10">
      </li>
